Set-Location 'C:\Users\DELL\OneDrive - hmritm.ac.in\Desktop\Codes\New folder (2)\delhi-ncr-pollution-platform\data-pipeline'
...
Write-Host '[service:pipeline-once] python runner.py' -ForegroundColor DarkGray
Invoke-Expression "python runner.py" *>&1 | Tee-Object -FilePath 'C:\Users\DELL\OneDrive - hmritm.ac.in\Desktop\Codes\New folder (2)\delhi-ncr-pollution-platform\.run-logs\pipeline-once.log'
