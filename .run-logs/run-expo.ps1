Set-Location 'C:\Users\DELL\OneDrive - hmritm.ac.in\Desktop\Codes\New folder (2)\delhi-ncr-pollution-platform\mobile-app'
...
Write-Host '[service:expo] npx expo start' -ForegroundColor DarkGray
Invoke-Expression "npx expo start" *>&1 | Tee-Object -FilePath 'C:\Users\DELL\OneDrive - hmritm.ac.in\Desktop\Codes\New folder (2)\delhi-ncr-pollution-platform\.run-logs\expo.log'
